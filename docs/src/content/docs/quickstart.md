...
title: Quickstart
description: >-
  Sign in, create a topic, write the prompt, add sources, and read your first findings.
  Five steps, about ten minutes.
---

This page takes you from zero to real topic findings in five steps.

## 1. Sign in

Go to [carlnotes.com](https://carlnotes.com) and pick a sign-in: **Continue with Google**,
...
Google there. Email sign-in works from inside the embedded browser, but signing in with your provider
from a real browser is the smoother path.
...
Saving the topic starts its first brew. You land on your new topic page with **"Carl is Brewing…"** already running.

![The topic page right after saving: Carl is Brewing in the header, and the first findings already
