...
- Domain nouns: Topic, Source, Scan, Resource, Finding, Feed, Subscription, Audience, Integration, Billing Subscription, Bookmark. Never Channel, Follow, Item, Update, Run, Crawl, Group, List, or Cohort.
...
- domain-model: canonical vocabulary: Topic, Source, Scan, Resource, Finding, Feed, Subscription, Audience, Integration, Billing Subscription, Bookmark; never introduce Channel, Follow, Item, Update, Run, Crawl, Group, List, Cohort
