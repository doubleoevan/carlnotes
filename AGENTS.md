...
- Module boundaries: ui never imports api, worker, or db; api and worker import db; db imports nothing app-level. Enforced by tsconfig project references once server modules exist.
