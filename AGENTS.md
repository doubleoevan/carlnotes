...
- Domain nouns: Topic, Source, Scan, Resource, Finding, Feed, Subscription, Audience, Integration, Billing Subscription, Bookmark, Chat Turn. Never Channel, Follow, Item, Update, Run, Crawl, Group, List, or Cohort.
