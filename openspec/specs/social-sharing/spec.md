...
The stored object's key SHALL cover the Topic id, a hash of the title, the owner username, and the counts, and a template version segment, so a renamed Topic or a renamed owner gets a new card url.
