...
- [ ] 8.8 At ship time, push the prompt to the registry with `bun run prompts:sync`. The registry still serves v1, and syncing before this lands would change what production suggests.
