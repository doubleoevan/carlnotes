...
Note badges tell a user that a note they can see holds something they have not read: an edit somebody
else made, or a comment somebody else wrote. The counts roll up from a note to its page and to
every place a page is named, so nothing has to be opened to be found.
