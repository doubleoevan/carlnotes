// the topic edit modal's teams field: every leader team is on offer, and the New team row is pinned beside them
...
// every leader team is a choice, in the order the index returned them
test("every leader team is on offer", () => {
...
test("no leader teams leaves only the pinned new team row", () => {
