...
// small documents make one chunk
// a document larger than maxChunks * chunkChars makes maxChunks larger chunks
export function chunk(text: string, maxChunks: number, chunkChars: number): string[] {
	...
	// pick the chunk count from the target size, capped at maxChunks, then size the chunks to cover the whole document
